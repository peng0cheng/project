...
/**************************************************【节点配置】**************************************************/
	...
	if(tag_page_jump){
		...
		tag_page_jump.find('input[dt_page_current]').live('keyup',function(){ _this.pageChange('current'); });//手输页码
...
/**************************************************【内部接口】**************************************************/
	...
	//【Ajax 分析】
	this.operationAjax = function(){
		var _url = ( this.option_ajax && this.option_ajax['url'] ) ? this.option_ajax['url'] : null;
		var _type = ( this.option_ajax && this.option_ajax['type'] ) ? this.option_ajax['type'] : 'GET';
		var _dataType = ( this.option_ajax && this.option_ajax['dataType'] ) ? this.option_ajax['dataType'] : 'JSON';
		this.option_ajax = {
			'url' : _url,
			'type' : _type,
			'dataType' : _dataType,
